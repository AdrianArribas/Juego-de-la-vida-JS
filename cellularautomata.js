class CellularAutomata {
    ...
    // 
    evaluate() {
        let cellsAux = new Array(100).fill("").map(() => new Array(100).fill(false)); //crea un array de 100 vacios, el map recorre el array y dentro de cada posicion crea otro array de 100 con cada elemento conteniendo un "false"
        for (let x = 0; x < this.size; x++) {
            for (let y = 0; y < this.size; y++) {
